...
def main(all_events):
    ...
    for _, [parking_id, _, plazas] in parkings_current_info.items():
        ...
        events_calculated.append([parking_id, {
            ...
            'Índice Ocupacion Rotación':      horas_r / oferta_servicio_horas_año, 
            'Índice Ocupacion Abonados':      horas_a / oferta_servicio_horas_año, 
            'Índice Ocupacion Total':         horas_t / oferta_servicio_horas_año,
